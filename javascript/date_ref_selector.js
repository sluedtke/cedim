$(document).ready(function() {
    ...
    // update the reference period select button content after selection
    $('#ref_list.dropdown-menu li > a').click(function(e){
        $('.selection').text(this.innerHTML);
        base_period = $(this).text();
    });

    // link the layer visibility to checkboxes of index.html
    ...
    $('#submit').click(function() {
        ...
        // full ajay request to get layer via python script
        para_ud={
